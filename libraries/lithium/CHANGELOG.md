...
- LIString::compare() will use native `hash_equals()` if possible. #1138 (David Persson)
...
- `LIString::compare()` is now stricter and errors out when one of the provided params is not a string. 7822a2b (David Persson)
