...
class Password {
	...
	public static function check($password, $hash) {
		return LIString::compare($hash, crypt($password, $hash));
	}
	 ...
	 * use the `'encode'` option of `LIString::random()` because it could result in 2 bits less of
	...
	protected static function _generateSaltXdes($count = null) {
		...
		$output .= LIString::random(3, array('encode' => LIString::ENCODE_BASE_64));
	...
	protected static function _generateSaltMd5() {
		return '$1$' . LIString::random(6, array('encode' => LIString::ENCODE_BASE_64));
	}
}
