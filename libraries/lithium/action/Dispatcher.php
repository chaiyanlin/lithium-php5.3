...
class Dispatcher extends \lithium\core\StaticObject {
	 ...
	 * `LIString::insert()`-formatted string. Alternatively, a callback can be used to do custom
	 * transformations other than the default `LIString::insert()`.
	 *
	...
	public static function applyRules(&$params) {
		...
		foreach ($rules as $rule => $value) {
			...
			foreach ($value as $k => $v) {
				...
				$values[$k] = LIString::insert($v, $values);
			}
		}
		return $values;
	}
